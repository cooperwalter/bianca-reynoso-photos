      ...
      <div class="">
        ...
        <div class="flex flex-col gap-4 mt-8 max-w-lg mx-auto text-center text-zinc-600 dark:text-zinc-400 text-sm">
          <slot name="description">
            <p>I would love to hear from you! Whether you have questions about my work, have collaboration ideas, or are interested in connecting, don't hesitate to reach out.</p>
        ...
        <ul class="mt-16 flex flex-col gap-4 lg:gap-12 lg:flex-row items-center justify-center max-w-2xl mx-auto">
          <li>
            <NuxtLink to="mailto:bianco.reynnoso@gmail.com" class="flex items-center gap-2 text-sm text-zinc-500 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-100">
              <Icon name="heroicons:envelope-20-solid" size="1.8rem" />
              <span>bianco.reynnoso@gmail.com</span>
            </NuxtLink>
          </li>
          <li>
            <NuxtLink to="https://instagram.com/biannryn" class="flex items-center gap-2 text-sm text-zinc-500 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-100">
      ...
      <svg viewBox="0 0 1024 1024" class="hidden dark:block absolute top-1/2 left-1/2 h-[64rem] w-[64rem] -translate-x-1/2 pointer-events-none" aria-hidden="true">
        ...
        <defs>
          <radialGradient id="759c1415-0410-454c-8f7c-9a820de03641" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(512 512) rotate(90) scale(512)">
            ...
            <stop offset="1" stop-color="#333626" stop-opacity="0"/>
          </radialGradient>
        </defs>
      </svg>
      <svg viewBox="0 0 1024 1024" class="dark:hidden absolute top-1/2 left-1/2 h-[64rem] w-[64rem] -translate-x-1/2 pointer-events-none" aria-hidden="true">
        ...
        <defs>
          <radialGradient id="759c1415-0410-454c-8f7c-9a820de03641" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(512 512) rotate(90) scale(512)">
            ...
            <stop offset="1" stop-color="#F3E0AD" stop-opacity="0"/>
          </radialGradient>
        </defs>
      </svg>
    </div>
