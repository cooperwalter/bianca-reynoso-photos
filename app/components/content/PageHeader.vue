...
<template>
  <div class="not-prose relative pt-14 pb-10 lg:mt-32 lg:pb-24">
    <div v-parallax class="absolute top-0 left-0 pointer-events-none w-full text-clip overflow-hidden" :class="[orientation === 'center' ? 'flex justify-center' : '']" data-rellax-speed="4">
